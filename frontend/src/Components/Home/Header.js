      ...
      <nav className="header row sticky-top">
          ...
          {isAuthenticated && user && (
            <div className='dropdown'>
              <span className="material-symbols-outlined web_logo dropdown-toggle" href="#" role='button' id='dropdownMenuLink' 
               data-bs-toggle="dropdown" aria-expanded="false">
                {user.avatar.url && (<img src={user.avatar.url} className='user-img' alt='icon' />)}
