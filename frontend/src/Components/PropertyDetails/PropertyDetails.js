...
const PropertyDetails = () => {
    ...
    const {propertyName, address, images, description, maximumGuest, amenities, extraInfo, price, currentBookings} = propertydetails;
                    ...
                    <>
                        ...
                        <div className='middle-container row'>
                            <div className='des-and-amenities col-md-8 col-sm-12 col-12'>
                                ...
                                <p>
                                    {description} <br/><br/> 
                                    Max no. of Guests: {maximumGuest} <br/><br/>
                                </p>
                                <hr/>
                        ...
                        <div className='property-map'>
                            <div className='map-image-exinfo-container row'>
                                ...
                                <div className='extra-info col-md-6 col-sm-12 col-12'>
                                    <h2 className='extra-header'>Extra Info</h2>
